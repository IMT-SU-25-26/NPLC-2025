    ...
    <>
        ...
        <div className='relative w-[100vw] overflow-hidden min-h-[90vh]'>
          ...
          <div className='flex justify-center items-center min-h-[80vh] w-full'>
            <div className='relative m-auto flex flex-col w-[50rem] h-[28rem] items-start px-28 pt-10'>
                <Image
                ...
                <h1 className=' text-[#FCF551] font-rubik-glitch text-[4rem] text-shadow-[-4px_0px_0px_#D379F1] m-0'>Submission</h1>
                <p className=' text-white'><b>Opened: </b> Sunday, 28 September 2025</p>
                <p className=' text-white'><b>Due: </b> Monday, 29 September 2025</p>
                <Image
