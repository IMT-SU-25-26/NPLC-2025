...
export default function CompetitionSection() {
    ...
    const getButtonImage = (id: ButtonData["id"]) =>
        `/buttons/${selected === id ? `selected-${id}-button.svg` : `unselected-${id}-button.svg`}`;

    const getUnselectedImage = (id: string) => {
        if (id === "business-plan") return `/buttons/unselected-business-plan-button.svg`;
    ...
    return (
        ...
        <div className="relative w-[700px] h-[350px] px-10">
        {/* Background card */}
        <Image
